...
to do:
 ...
 3. эксперименты: 
    ...
    ~~промты на английском~~ подумала и решила, что для ллм хорошо работают примеры в промте, если их сделать на англе, то норм не напишешь, так что не будем; 
...
15. в случае multi.relation если есть название дисциплины не в реальном списке, то он просто скипает его и идет дальше. Надо обработать
