...
to do:
 ...
 4. ~~в оценку надо добавить метрику классификации названия предмета (перед этим доработать датасет, разнообразие названий в вопросах сделать)~~ добавила
...
19. Думаю, что надо поменять логику reranker для multi relation запросов, так как часто попадают туда данные только из одной дисциплины
